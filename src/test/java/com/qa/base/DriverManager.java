...
//        String userName = System.getenv("BROWSERSTACK_USERNAME");
          String userName = "adityaautomation_gSGNLE";


//          String accessKey = System.getenv("BROWSERSTACK_ACCESS_KEY");
          String accessKey = "7zJHvQx6E6iNjGuHd7ba";
...
//        capabilities.setCapability("app", app);
        ...
        capabilities.setCapability("deviceName", jsonObject.getString("device"));
        capabilities.setCapability("os_version", jsonObject.getString("os_version"));
        ...
        capabilities.setCapability("app", jsonObject.getString("app_url"));
//        capabilities.setCapability("app", app);
